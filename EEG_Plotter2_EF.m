...
LeaveOut=(strcmp(DataTable_Current.Name,'14248-05')&(strcmp(DataTable_Current.Channel,'right-M')|strcmp(DataTable_Current.Channel,'right-S')))|... % Right Average (RA), DE
         (strcmp(DataTable_Current.Name,'14346-01')&(strcmp(DataTable_Current.Channel,'left-S') |strcmp(DataTable_Current.Channel,'left-M')) )|... % Left Average (LA), DE
         (strcmp(DataTable_Current.Name,'14346-03')&(strcmp(DataTable_Current.Channel,'right-M')|strcmp(DataTable_Current.Channel,'right-S')))|... % RA, DE
         (strcmp(DataTable_Current.Name,'14351-02')&(strcmp(DataTable_Current.Channel,'right-S')|strcmp(DataTable_Current.Channel,'right-M')))|... % RA, no E measurement
         (strcmp(DataTable_Current.Name,'14463-01'))|... % Full Average (FA), DE 
         (strcmp(DataTable_Current.Name,'14463-02')&(strcmp(DataTable_Current.Channel,'right-M')|strcmp(DataTable_Current.Channel,'right-S')))|... % RA, DE
         (strcmp(DataTable_Current.Name,'14463-03')&strcmp(DataTable_Current.Channel,'right-S'))|... % right-S X, DE
         (strcmp(DataTable_Current.Name,'14578-01'))|... % Left Switch (LS), DE
         (strcmp(DataTable_Current.Name,'14578-02')&strcmp(DataTable_Current.Day,'E1')&(strcmp(DataTable_Current.Channel,'right-S')|strcmp(DataTable_Current.Channel,'right-M')))|... % RA, E
         (strcmp(DataTable_Current.Name,'14783-02')&(strcmp(DataTable_Current.Channel,'right-S')|strcmp(DataTable_Current.Channel,'right-M')))|... % RA, DE
         (strcmp(DataTable_Current.Name,'15056-02')&strcmp(DataTable_Current.Day,'E1'))|... % AA noise (due to movement?), E
         (strcmp(DataTable_Current.Name,'15096-05')&(strcmp(DataTable_Current.Channel,'left-S')|strcmp(DataTable_Current.Channel,'left-M')))|... % LA, DE
         (strcmp(DataTable_Current.Name,'15096-05')&strcmp(DataTable_Current.Channel,'right-S'))|... % right-S X, DE
         ... % G5
         (strcmp(DataTable_Current.Name,'15250-03')&strcmp(DataTable_Current.Day,'E1')&(strcmp(DataTable_Current.Channel,'right-S')|strcmp(DataTable_Current.Channel,'right-M')))|... % RA, E, possibly G5
         (strcmp(DataTable_Current.Name,'15250-05'))|... % Decision 2 failed, no E measurement
         (strcmp(DataTable_Current.Name,'15252-02')&strcmp(DataTable_Current.Channel,'right-S'))|... % right-S X, DE
...%          strcmp(DataTable_Current.Name,'15252-04')&(strcmp(DataTable_Current.Channel,'right-S')|strcmp(DataTable_Current.Channel,'right-M'))|... % right X, DE
         (strcmp(DataTable_Current.Name,'15252-04'))|... % right X, left noisy, DE
         (strcmp(DataTable_Current.Name,'15332-03')&(strcmp(DataTable_Current.Channel,'right-M')|strcmp(DataTable_Current.Channel,'right-S')))|... % RA, DE
...%          strcmp(DataTable_Current.Name,'15332-05')|... % suggestion rejected everything (very high EEG amplitude everywhere)
         (strcmp(DataTable_Current.Name,'15332-05')&strcmp(DataTable_Current.Channel,'left-S'))|... % left-S pure noise, DE
     ...
     ...%strcmp(DataTable_Current.Name,'17148-06')&strcmp(DataTable_Current.Channel,'left-S')|... % no signal
         ...
         ...% G7
         (strcmp(DataTable_Current.Name,'19077-03')&strcmp(DataTable_Current.Day,'D1'))|... % right-S X, switch right-M with left-S
         (strcmp(DataTable_Current.Name,'19077-04')&strcmp(DataTable_Current.Day,'D1')); % right-S X, switch right-M with left-S
...
if nowtrescue
    uniq.Genotype={'wt';'hetrescue';'het'}; %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
else
...
% anova start
anova_data=cell(nGenotype_bandtable,1);
g1=cell(nGenotype_bandtable,1);
g2=cell(nGenotype_bandtable,1);
for g=1:nGenotype_bandtable
    
    anova_data(g)={power_cellmatrix{i,ii,g,j,jj}};
    if strcmp(Genotype_bandtable{g},'wt')||strcmp(Genotype_bandtable{g},'wtrescue')
        g1{g}=repmat({'wt'},[1,length(anova_data{g})]);
    else
        g1{g}=repmat({'het'},[1,length(anova_data{g})]);
    end
    if strcmp(Genotype_bandtable{g},'wtrescue')||strcmp(Genotype_bandtable{g},'hetrescue')
...
for g=1:size(results,2)
    ...
    P(find(strcmp(uniq.Genotype,gname_temp1)),find(strcmp(uniq.Genotype,gname_temp2)))=results(g,end);
    P(find(strcmp(uniq.Genotype,gname_temp2)),find(strcmp(uniq.Genotype,gname_temp1)))=results(g,end);
...
%     h(3,1)=histogram(DataMatrix(strcmp(DataMatrix_Genotype,'hetrescue'),i),'FaceColor',c(2,:),'NumBins',10);
      if nowtrescue
          ...
          nGen=length(Gen);
boxplot([DataMatrix(strcmp(DataMatrix_Genotype,Gen{1}),i);...
              DataMatrix(strcmp(DataMatrix_Genotype,Gen{2}),i);...
              DataMatrix(strcmp(DataMatrix_Genotype,Gen{3}),i)],...
              [repmat({['WT (n=',num2str(sum(strcmp(DataMatrix_Genotype,Gen{1}))),')']},[sum(strcmp(DataMatrix_Genotype,Gen{1})),1]);...
               repmat({['het+ (n=',num2str(sum(strcmp(DataMatrix_Genotype,Gen{2}))),')']},[sum(strcmp(DataMatrix_Genotype,Gen{2})),1]);...
               repmat({['het- (n=',num2str(sum(strcmp(DataMatrix_Genotype,Gen{3}))),')']},[sum(strcmp(DataMatrix_Genotype,Gen{3})),1])],...
               'Colors',c([3,2,1],:))
      else
      ...
      boxplot([DataMatrix(strcmp(DataMatrix_Genotype,Gen{1}),i);...
               DataMatrix(strcmp(DataMatrix_Genotype,Gen{2}),i);...
               DataMatrix(strcmp(DataMatrix_Genotype,Gen{3}),i);...
               DataMatrix(strcmp(DataMatrix_Genotype,Gen{4}),i)],...
              [repmat({['WT (n=',num2str(sum(strcmp(DataMatrix_Genotype,Gen{1}))),')']},[sum(strcmp(DataMatrix_Genotype,Gen{1})),1]);...
               repmat({['WT+ (n=',num2str(sum(strcmp(DataMatrix_Genotype,Gen{2}))),')']},[sum(strcmp(DataMatrix_Genotype,Gen{2})),1]);...
               repmat({['het+ (n=',num2str(sum(strcmp(DataMatrix_Genotype,Gen{3}))),')']},[sum(strcmp(DataMatrix_Genotype,Gen{3})),1]);...
               repmat({['het- (n=',num2str(sum(strcmp(DataMatrix_Genotype,Gen{4}))),')']},[sum(strcmp(DataMatrix_Genotype,Gen{4})),1])],...
               'Colors',c([3,4,2,1],:))
      end
...
%     legend(h,{'wt';'het'})
    ...
    if nowtrescue
    Data_Current={DataMatrix(strcmp(DataMatrix_Genotype,Gen{1}),i);...
                  DataMatrix(strcmp(DataMatrix_Genotype,Gen{2}),i);...
                  DataMatrix(strcmp(DataMatrix_Genotype,Gen{3}),i)};
    else
    Data_Current={DataMatrix(strcmp(DataMatrix_Genotype,Gen{1}),i);...
...
% xlim([0.5   11.7088])
% end
%% Concatenate DataTable's
% clearvars
% close all
% load('DataTable.mat')
% load('DataTable_StartTime.mat')
% DataTable2_2=DataTable2;
% DataTable3_2=DataTable3;
% DataTable4_2=DataTable4;
% DataTable5_2=DataTable5;
% DataTable6_2=DataTable6;
% DataTable_Percentages_2=DataTable_Percentages;
% DataTable_StartTime_2=DataTable_StartTime;
% load('DataTable.mat')
% load('DataTable_StartTime.mat')
% DataTable2=[DataTable2;DataTable2_2];
% DataTable3=[DataTable3;DataTable3_2];
% DataTable4=[DataTable4;DataTable4_2];
% DataTable5=[DataTable5;DataTable5_2];
% DataTable6=[DataTable6;DataTable6_2];
% DataTable_Percentages=[DataTable_Percentages;DataTable_Percentages_2];
% DataTable_StartTime=[DataTable_StartTime;DataTable_StartTime_2];
% save('DataTable_2','DataTable2','DataTable3','DataTable_Percentages','DataTable4','DataTable5','DataTable6')
% save('DataTable_StartTime_2','DataTable_StartTime')
%% barplot adjust
% for i=1:6
% subplot(3,2,i)
% xlim([0,12.8]),ylim('auto')
% if i==1||i==3||i==5
% positionval=get(legend,'position');
% positionval(1)=positionval(1)+0.075;
% set(legend,'Position',positionval)
% else
